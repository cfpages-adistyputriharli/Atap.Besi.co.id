...
description: "Trace pressure/suction through panel, side laps, fasteners/clips, purlins, bracing, frames, connections, and foundations"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Load Path Angin dari Panel Atap ke Struktur Bangunan”
- **Reader and situation:** Owner reviewing wind design
- **Reader outcome:** Trace pressure/suction through panel, side laps, fasteners/clips, purlins, bracing, frames, connections, and foundations
- **Primary intent:** Understand force transfer
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** No capacity or spacing; licensed design and RFM-07-A03 own values
- **Final public route:** `/artikel/load-path-angin-atap-metal.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Load Path Angin dari Panel Atap ke Struktur Bangunan**.
...
- **Exact Markdown to insert:** `![Ilustrasi struktur bangunan](/wp-content/uploads/2024/07/struktur-bangunan.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `struktur bangunan` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Load Path Angin dari Panel Atap ke Struktur Bangunan”.
