---
article_id: RFM-15-A01
title: "Checklist Baseline Inspection Atap Metal"
slug: "baseline-inspection-atap-metal"
description: "Record identity, documents, safe-access status, panels, supports visible, fasteners, laps, flashings, penetrations, coating, drainage, interior, defects, and photos"
status: outline
...
final_route: "/artikel/baseline-inspection-atap-metal.html"
...
# Checklist Baseline Inspection Atap Metal

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Checklist Baseline Inspection Atap Metal”
- **Reader and situation:** Owner receiving a new/existing roof
- **Reader outcome:** Record identity, documents, safe-access status, panels, supports visible, fasteners, laps, flashings, penetrations, coating, drainage, interior, defects, and photos
- **Primary intent:** Establish initial condition
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not certify safety/watertightness; RFM-07-A01 and responsible reviewers own acceptance
- **Final public route:** `/artikel/baseline-inspection-atap-metal.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Checklist Baseline Inspection Atap Metal**.
...
- **Tie back to this article:** Keep the explanation specific to “Checklist Baseline Inspection Atap Metal”.
