...
description: "Gather rainfall source, catchment geometry, slopes, valley flow, outlets, overflow, blockage, discharge route, maintenance, and climate uncertainty"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Data yang Dibutuhkan untuk Merancang Drainase Atap”
- **Reader and situation:** Owner/engineer before gutter sizing
- **Reader outcome:** Gather rainfall source, catchment geometry, slopes, valley flow, outlets, overflow, blockage, discharge route, maintenance, and climate uncertainty
- **Primary intent:** Prepare drainage inputs
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** No gutter/downpipe size or rainfall value; responsible hydraulic design owns calculations
- **Final public route:** `/artikel/data-untuk-desain-drainase-atap.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Data yang Dibutuhkan untuk Merancang Drainase Atap**.
...
- **Tie back to this article:** Keep the explanation specific to “Data yang Dibutuhkan untuk Merancang Drainase Atap”.
