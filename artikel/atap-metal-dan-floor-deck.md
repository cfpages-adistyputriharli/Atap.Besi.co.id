---
article_id: RFM-01-A05
title: "Atap Metal dan Floor Deck: Mengapa Profil Mirip Bisa Beda Fungsi"
slug: "atap-metal-dan-floor-deck"
description: "Compare weather-envelope versus composite-floor roles, supports, loads, laps, concrete interface, finishes, and evidence"
status: outline
publication_date: "2025-07-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RFM-01
primary_intent: "Distinguish roof and floor deck"
reader_community: "Besi.co.id"
reader_address: "Sobat Besi.co.id"
final_route: "/artikel/atap-metal-dan-floor-deck.html"
...
# Atap Metal dan Floor Deck: Mengapa Profil Mirip Bisa Beda Fungsi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Atap Metal dan Floor Deck: Mengapa Profil Mirip Bisa Beda Fungsi”
- **Reader and situation:** Buyer considering bondek as roofing
- **Reader outcome:** Compare weather-envelope versus composite-floor roles, supports, loads, laps, concrete interface, finishes, and evidence
- **Primary intent:** Distinguish roof and floor deck
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not design roof or slab; RFM-07-A01 and `/bondek-floor-deck/` own structural/commercial intent
- **Final public route:** `/artikel/atap-metal-dan-floor-deck.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Atap Metal dan Floor Deck: Mengapa Profil Mirip Bisa Beda Fungsi**.
...
- **Exact Markdown to insert:** `![Ilustrasi Bondek Floor Deck](/wp-content/uploads/2026/03/Bondek-Floor-Deck.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Bondek Floor Deck` as relevant content media; no pixels were inspected.
...
- `/bondek-floor-deck/` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/category/bondek-floor-deck/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Atap Metal dan Floor Deck: Mengapa Profil Mirip Bisa Beda Fungsi”.
