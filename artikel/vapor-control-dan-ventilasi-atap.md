---
article_id: RFM-06-A04
title: "Vapor Control, Airtightness, dan Ventilasi Roof Space"
slug: "vapor-control-dan-ventilasi-atap"
description: "Explain vapor drive, air transport, layer continuity, penetrations, drying direction, ventilation paths, climate/operation, and inspection"
status: outline
publication_date: "2025-11-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RFM-06
primary_intent: "Coordinate moisture controls"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/vapor-control-dan-ventilasi-atap.html"
...
# Vapor Control, Airtightness, dan Ventilasi Roof Space

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Vapor Control, Airtightness, dan Ventilasi Roof Space”
- **Reader and situation:** Designer selecting layer strategy
- **Reader outcome:** Explain vapor drive, air transport, layer continuity, penetrations, drying direction, ventilation paths, climate/operation, and inspection
- **Primary intent:** Coordinate moisture controls
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not prescribe barrier position or vent ratio; project hygrothermal design owns solution
- **Final public route:** `/artikel/vapor-control-dan-ventilasi-atap.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Vapor Control, Airtightness, dan Ventilasi Roof Space**.
...
- **Tie back to this article:** Keep the explanation specific to “Vapor Control, Airtightness, dan Ventilasi Roof Space”.
