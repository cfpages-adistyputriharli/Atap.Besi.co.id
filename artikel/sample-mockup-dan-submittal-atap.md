---
article_id: RFM-12-A04
title: "Sample, Mockup, dan Submittal sebelum Produksi Atap"
slug: "sample-mockup-dan-submittal-atap"
description: "Define profile sample, color/finish, certificates/data, detail mockup, fasteners/sealants, interfaces, acceptance, retention, and change control"
status: outline
publication_date: "2026-04-15"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RFM-12
primary_intent: "Verify product/detail before release"
reader_community: "Besi.co.id"
reader_address: "Teman Besi.co.id"
final_route: "/artikel/sample-mockup-dan-submittal-atap.html"
...
# Sample, Mockup, dan Submittal sebelum Produksi Atap

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sample, Mockup, dan Submittal sebelum Produksi Atap”
- **Reader and situation:** Owner approving appearance/buildability
- **Reader outcome:** Define profile sample, color/finish, certificates/data, detail mockup, fasteners/sealants, interfaces, acceptance, retention, and change control
- **Primary intent:** Verify product/detail before release
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Sample does not prove structural/weather performance; RFM-07-A06 and approved tests own them
- **Final public route:** `/artikel/sample-mockup-dan-submittal-atap.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sample, Mockup, dan Submittal sebelum Produksi Atap**.
...
- `RFM-12-A05` → `/artikel/receiving-inspection-panel-atap.html` — Receiving Inspection Panel dan Aksesori Atap Metal
- `RFM-12-A06` → `/artikel/handover-dossier-atap-metal.html` — Paket Handover Atap: As-Built, Test, Warranty, dan Maintenance
...
- **Tie back to this article:** Keep the explanation specific to “Sample, Mockup, dan Submittal sebelum Produksi Atap”.
