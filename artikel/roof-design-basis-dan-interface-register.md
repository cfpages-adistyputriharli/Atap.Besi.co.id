---
article_id: RFM-03-A06
title: "Menyusun Roof Design Basis dan Interface Register"
slug: "roof-design-basis-dan-interface-register"
description: "Record inputs, assumptions, owners, decisions, revisions, product data, structure, drainage, physics, penetrations, and unresolved interfaces"
status: outline
...
final_route: "/artikel/roof-design-basis-dan-interface-register.html"
...
# Menyusun Roof Design Basis dan Interface Register

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Menyusun Roof Design Basis dan Interface Register”
- **Reader and situation:** Project lead before detailed design
- **Reader outcome:** Record inputs, assumptions, owners, decisions, revisions, product data, structure, drainage, physics, penetrations, and unresolved interfaces
- **Primary intent:** Coordinate disciplines
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not validate calculations; relevant RFM-04 to RFM-09 owners approve discipline work
- **Final public route:** `/artikel/roof-design-basis-dan-interface-register.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menyusun Roof Design Basis dan Interface Register**.
...
- **Tie back to this article:** Keep the explanation specific to “Menyusun Roof Design Basis dan Interface Register”.
