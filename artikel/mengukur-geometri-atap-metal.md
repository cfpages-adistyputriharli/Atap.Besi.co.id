---
article_id: RFM-03-A03
title: "Mengukur Roof Plan, Slope, Panjang Panel, dan Penetrasi"
slug: "mengukur-geometri-atap-metal"
description: "Record plan dimensions, slopes, ridges, hips, valleys, eaves, panel direction, penetrations, datum, tolerances, and as-built uncertainty"
status: outline
publication_date: "2025-08-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RFM-03
primary_intent: "Build geometry evidence"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/mengukur-geometri-atap-metal.html"
...
# Mengukur Roof Plan, Slope, Panjang Panel, dan Penetrasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mengukur Roof Plan, Slope, Panjang Panel, dan Penetrasi”
- **Reader and situation:** Surveyor or estimator measuring a roof
- **Reader outcome:** Record plan dimensions, slopes, ridges, hips, valleys, eaves, panel direction, penetrations, datum, tolerances, and as-built uncertainty
- **Primary intent:** Build geometry evidence
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not calculate drainage or quantity; RFM-08-A02 and RFM-12-A02 own them
- **Final public route:** `/artikel/mengukur-geometri-atap-metal.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengukur Roof Plan, Slope, Panjang Panel, dan Penetrasi**.
...
- `/atap-seng-padang-panjang.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/atap-seng-padang-panjang` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/atap-galvalum-padang-panjang.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/atap-galvalum-padang-panjang` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Mengukur Roof Plan, Slope, Panjang Panel, dan Penetrasi”.
