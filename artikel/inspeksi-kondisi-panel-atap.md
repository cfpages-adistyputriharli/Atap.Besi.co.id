---
article_id: RFM-15-A04
title: "Inspeksi Korosi, Dents, Oil Canning, dan Panel Distress"
slug: "inspeksi-kondisi-panel-atap"
description: "Map coating failure, cut edges, corrosion, dents/creases, deformation, loose areas, fasteners, moisture context, history, and escalation"
status: outline
publication_date: "2026-06-25"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RFM-15
primary_intent: "Assess panel condition"
reader_community: "Besi.co.id"
reader_address: "Kawan Besi.co.id"
final_route: "/artikel/inspeksi-kondisi-panel-atap.html"
...
# Inspeksi Korosi, Dents, Oil Canning, dan Panel Distress

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Inspeksi Korosi, Dents, Oil Canning, dan Panel Distress”
- **Reader and situation:** Maintainer observing deterioration
- **Reader outcome:** Map coating failure, cut edges, corrosion, dents/creases, deformation, loose areas, fasteners, moisture context, history, and escalation
- **Primary intent:** Assess panel condition
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not diagnose capacity/life; RFM-07-A04 and RFM-10-A02 own structural/environment review
- **Final public route:** `/artikel/inspeksi-kondisi-panel-atap.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Inspeksi Korosi, Dents, Oil Canning, dan Panel Distress**.
...
- `RFM-15-A02` → `/artikel/investigasi-kebocoran-atap-metal.html` — Investigasi Kebocoran Atap Metal tanpa Menebak
- `RFM-15-A03` → `/artikel/repair-fastener-sealant-dan-flashing.html` — Repair Fastener, Sealant, dan Flashing: Bukti sebelum Menambal
- `RFM-15-A05` → `/artikel/maintenance-drainase-atap.html` — Maintenance Gutter, Valley, Outlet, dan Overflow
- `RFM-15-A06` → `/artikel/inspeksi-atap-setelah-cuaca-ekstrem.html` — Inspeksi Atap setelah Angin Kencang, Hujan Ekstrem, atau Impact
...
- **Tie back to this article:** Keep the explanation specific to “Inspeksi Korosi, Dents, Oil Canning, dan Panel Distress”.
