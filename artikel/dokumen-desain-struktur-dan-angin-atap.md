...
description: "Define design basis, geometry, inputs, zones, load path, product tests, supports, fasteners, calculations, drawings, temporary states, revisions, signoff"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Dokumen Desain Struktur dan Angin yang Harus Ada”
- **Reader and situation:** Owner before procurement/installation
- **Reader outcome:** Define design basis, geometry, inputs, zones, load path, product tests, supports, fasteners, calculations, drawings, temporary states, revisions, signoff
- **Primary intent:** Audit structural submittals
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Completeness does not validate calculations; licensed reviewer owns approval
- **Final public route:** `/artikel/dokumen-desain-struktur-dan-angin-atap.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dokumen Desain Struktur dan Angin yang Harus Ada**.
...
- **Tie back to this article:** Keep the explanation specific to “Dokumen Desain Struktur dan Angin yang Harus Ada”.
